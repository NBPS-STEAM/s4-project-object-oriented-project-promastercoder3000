...
public class Minerals{
  ...
  public static String[] minerals = {"Bronze", "Silver", "Gold", "Diamond", "Bronze", "Silver", "Gold", "Bronze", "Silver", "Bronze"}; /*minerals available in the game, each material has its own worth as well as weight in pounds.
   ...
   public void findRandMineral(Miner minerObj){
    ...
    minerObj.playerInventory.add(minerals[randItem]);
      if(minerals[randItem].equals("Bronze")){ // an if statement that checks if the element indicated by the randomly generated index of the array is equal to the string "Bronze" 
        ...
        minerObj.setAdditionalWealth(12); // increase the value of the integer variable weightInPounds by 12 if the if statement is true
      }
        ...
        minerObj.setAdditionalWealth(24); // increase the value of the integer variable weightInPounds by 24 if the if statement is true
      }
        ...
        minerObj.setAdditionalWealth(48); // increase the value of the integer variable weightInPounds by 48 if the if statement is true
      }
        ...
        minerObj.setAdditionalWealth(96); // increase the value of the integer variable weightInPounds by 96 if the if statement is true.
      }
   }
